...
namespace Coimbra.Services.Roslyn
{
    ...
    public class ServiceLocatorUsageAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static void AnalyzeServiceLocatorUsage(SyntaxNodeAnalysisContext context)
        {
            ...
            else if (typeSymbol.HasAttribute(CoimbraServicesTypes.AbstractServiceAttribute, CoimbraServicesTypes.Namespace))
            {
