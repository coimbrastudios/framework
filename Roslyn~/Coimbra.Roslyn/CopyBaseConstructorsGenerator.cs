...
namespace Coimbra.Roslyn
{
    ...
    {
        private static IEnumerable<CopyBaseConstructorsTypeInfo> EnumerateTypes(GeneratorExecutionContext context)
        {
            ...
            {
                if (context.Compilation.GetSemanticModel(type.ClassDeclaration.SyntaxTree).GetDeclaredSymbol(type.ClassDeclaration) is not ITypeSymbol { BaseType: not null } classType
                ...
                yield return new CopyBaseConstructorsTypeInfo
                {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (CopyBaseConstructorsTypeInfo type in EnumerateTypes(context))
            {
