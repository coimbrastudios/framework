...
namespace Coimbra.Editor
{
    ...
    public sealed class FloatRangeDrawer : PropertyDrawer
    {
        ...
        public static void DrawGUI(Rect position, SerializedProperty minProperty, SerializedProperty maxProperty, bool delayed)
        {
            ...
            using (EditorGUI.PropertyScope propertyScope = new(position, new GUIContent(nameof(FloatRange.Min)), minProperty))
            {
            ...
            using (EditorGUI.PropertyScope propertyScope = new(position, new GUIContent(nameof(FloatRange.Max)), maxProperty))
            {
