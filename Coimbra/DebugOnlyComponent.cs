...
namespace Coimbra
{
    ...
    /// </summary>
    [AddComponentMenu(CoimbraUtility.GeneralMenuPath + "Debug Only Component")]
    public sealed class DebugOnlyComponent : ActorComponentBase, ISceneProcessorComponent
    {
        [SerializeField]
        [DisableOnPlayMode]
